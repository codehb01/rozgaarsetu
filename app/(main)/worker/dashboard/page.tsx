    ...
    <main className="min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Avg Rating Given</p>
      ...
      <Card className="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl mb-8">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Total Earnings</h2>
          ...
          <Link href="/worker/job" className="group">
            <Card className="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white">Job Requests</p>
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">View pending requests</p>
              </div>
            </Card>
          </Link>
          ...
          <Link href={`/workers/${worker.id}`} className="group">
            <Card className="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">See your public profile</p>
              </div>
            </Card>
          </Link>
          ...
          <Link href="/worker/profile" className="group">
            <Card className="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Update preferences</p>
              </div>
            </Card>
          </Link>
        </div>
      ...
      <div className="mb-8">
        ...
        {recentJobs.length === 0 ? (
          <Card className="p-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-center">
            <div className="text-gray-500 dark:text-gray-400">No jobs yet</div>
