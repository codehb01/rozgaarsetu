        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">
              <TranslatedText context="worker-profile">My Profile</TranslatedText>
            </h1>
            <p className="text-gray-600 dark:text-gray-400">
              <TranslatedText context="worker-profile">Manage your professional information and portfolio</TranslatedText>
            </p>
          </div>
          {!isEditing ? (
            <Button
            ...
            >
              ...
              <TranslatedText context="worker-profile">Edit Profile</TranslatedText>
            </Button>
          ) : (
            <div className="flex gap-2">
              ...
              >
                ...
                <TranslatedText context="worker-profile">Cancel</TranslatedText>
              </Button>
            </div>
          )}
        </div>
