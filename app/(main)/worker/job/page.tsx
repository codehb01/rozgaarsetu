      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">
            <TranslatedText context="worker-jobs">Jobs</TranslatedText>
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            <TranslatedText context="worker-jobs">Manage and track your job requests</TranslatedText>
          </p>
        </div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                        ...
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white text-xs">
                            <TranslatedText context="worker-jobs">Date & Time</TranslatedText>
                          </p>
                          <p className="text-xs">
                    ...
                    {j.details && (
                      <div className="p-2 bg-blue-50 dark:bg-blue-900/10 rounded-lg">
                        <p className="text-xs font-medium text-blue-600 dark:text-blue-400 mb-1">
                          <TranslatedText context="worker-jobs">Additional Details</TranslatedText>
                        </p>
                        <p className="text-xs text-gray-700 dark:text-gray-200 line-clamp-2">
                          <TranslatedText context="worker-jobs">{j.details}</TranslatedText>
                        </p>
                      </div>
                    )}
                      ...
                      j.review && (
                        <div className="p-2 bg-purple-50 dark:bg-purple-900/10 rounded-lg">
                          <p className="text-xs font-medium text-purple-600 dark:text-purple-400 mb-1">
                            <TranslatedText context="worker-jobs">Customer Review</TranslatedText>
                          </p>
