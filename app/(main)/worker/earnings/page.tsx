      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            <TranslatedText context="worker-earnings">Track your income and completed jobs</TranslatedText>
          </p>
        </div>
          ...
          {loading ? (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                <TranslatedText context="worker-earnings">There was an error loading your earnings. Please try again.</TranslatedText>
              </p>
              <button
                onClick={load}
                className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
              >
                <TranslatedText context="worker-earnings">Retry</TranslatedText>
              </button>
            </motion.div>
          ) : (
            <motion.div
