                      ...
                      >
                        ...
                        <div className="flex flex-col md:flex-row gap-3 justify-center md:justify-start">
                          <div className="flex items-center justify-center md:justify-start text-gray-600 dark:text-gray-400">
                            ...
                            <span className="text-sm">{workerDetails.city}, {workerDetails.state}</span>
                          </div>
                          <div className="flex items-center justify-center md:justify-start text-gray-600 dark:text-gray-400">
                            <Briefcase className="h-4 w-4 mr-2 text-purple-600" />
                            <span className="text-sm">{workerDetails.yearsExperience} years experience</span>
                          </div>
                        </div>
                      </motion.div>
                ...
                <CardContent className="p-6 md:p-10">
                  <div className="text-center mb-8">
                    ...
                    >
                      ...
                      <span className="text-sm md:text-base">{customerDetails.city}, {customerDetails.state}</span>
                    </motion.div>
                  </div>
                  ...
                  >
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-400 bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-gray-700/30 dark:to-gray-800/30 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="text-sm md:text-base">{customerDetails.country}</p>
                    </div>
                  </motion.div>
                </CardContent>
              </Card>
