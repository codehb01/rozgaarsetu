                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="text-base text-purple-600/80 dark:text-purple-400/70 font-medium">
                      <TranslatedText context="onboarding">Offer your services</TranslatedText>
                    </CardDescription>
                  </div>
                </div>
                <ArrowRight
      ...
      >
        <div className="flex items-center justify-center gap-6 text-sm text-gray-600 dark:text-gray-400 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium"><TranslatedText context="onboarding">Secure platform</TranslatedText></span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium"><TranslatedText context="onboarding">Verified profiles</TranslatedText></span>
          </div>
          <div className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-700"></div>
          <div className="flex items-center gap-2">
            <Sparkles className="h-4 w-4 text-blue-500 dark:text-blue-400" />
            <span className="font-medium"><TranslatedText context="onboarding">Protected payments</TranslatedText></span>
          </div>
        </div>
      </motion.div>
    </div>
